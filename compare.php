        ...
        <div class="small-12 medium-12 large-12 columns">
          ...
          <div class="party-topic-list">
                ...
                <ul class="policies">
                  ...
                  <li class="btn"><a>Pipelines</a></li>
                  <li class="btn"><a>Health Care</a></li>
                  <li class="btn"><a>Infrastructure</a></li>
                  <li class="btn"><a>Senate</a></li>
                  <li class="btn"><a>Corporate Taxes</a></li>
                  <li class="btn"><a>Small Business Taxes</a></li>
...
<!-- row 2 -->
            <div class="all-party-policy mariana small-12 medium-12 large-12 columns">
                <div class="parties-pol small-12 medium-12 large-3 columns">
                    <div><h4>NDP</h4>
    ...
    <!--row 3 -->
        <div class="all-party-policy youth small-12 medium-12 large-12 columns">
            <div class="parties-pol small-12 medium-12 large-3 columns">
                <div><h4>NDP</h4>
        ...
        <!--row 4 -->
        <div class="all-party-policy pipes small-12 medium-12 large-12 columns">
            <div class="parties-pol small-12 medium-12 large-3 columns">
                <div><h4>NDP</h4>
        ...
        <!--row 5 -->
        <div class="all-party-policy health small-12 medium-12 large-12 columns">
            <div class="parties-pol small-12 medium-12 large-3 columns">
                <div><h4>NDP</h4>
        ...
        <!--row 6 -->
        <div class="all-party-policy infra small-12 medium-12 large-12 columns">
            <div class="parties-pol small-12 medium-12 large-3 columns">
                <div><h4>NDP</h4>
        ...
        <!--row 7 -->
        <div class="all-party-policy senate small-12 medium-12 large-12 columns">
            <div class="parties-pol small-12 medium-12 large-3 columns">
              <div><h4>NDP</h4>
...
<!--row 8-->
        ...
        <!--row 9-->
                <div class="all-party-policy small-tax small-12 medium-12 large-12 columns">
                    <div class="parties-pol small-12 medium-12 large-3 columns">
                        <div><h4>NDP</h4>
                        <p>The NDP supports the Conservative tax cut to small businesses, and say they will keep the cut from 11 per cent to 9.</p></div>
                        <div><h3 class="voteBtn btn voteButton" data-vote="ndp1">Vote</h3></div>
                    </div>
